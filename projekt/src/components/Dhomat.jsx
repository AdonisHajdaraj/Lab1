...
const Dhomat = () => {
                    ...
                    {data.map((dhoma, index) => (
                        <div key={index} className="col-12 col-md-6 col-lg-4">
                            <div className="card">
                                ...
                                {dhoma.image && <img src={dhoma.image} alt="" />}
                            ...
                            <div className="modal-body">
                                <form>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <textarea className="form-control" id="pershkrimi" rows="3" value={values.pershkrimi} onChange={(e) => setValues({ ...values, pershkrimi: e.target.value })}></textarea>
                                    </div>
                                    <div className="form-group">
                                        <label htmlFor="image">Image</label>
                                        <input type="text" className="form-control" id="image" value={values.image} onChange={(e) => setValues({ ...values, image: e.target.value })} />
                                    </div>
                                </form>
                            </div>
    ...
    {editId !== null ? <button type="button" className="btn btn-primary" onClick={handleUpdate}>Save changes</button> : <button type="button" className="btn btn-primary" onClick={handleAdd}>Add</button>}
</div>
